defmodule AlquimiaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AlquimiaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AlquimiaWeb.Gettext, "errors", msg, opts)
    end
  end
